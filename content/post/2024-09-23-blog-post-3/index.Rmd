...
```
```{r 2024-polling-averages, echo=FALSE}
...
```{r more-polling-averages, echo=FALSE}
...
d_fund <- d_combined |> 
  select("year", "pv2p", "GDP", "GDP_growth_quarterly", "RDPI",
         "RDPI_growth_quarterly", "CPI", "unemployment", "sp500_close",
         "incumbent", "gdp_growth_x_incumbent", "rdpi_growth_quarterly",
         "cpi_x_incumbent", "unemployment_x_incumbent", "sp500_x_incumbent",
         "pv2p_lag1", "pv2p_lag2") 
...
polls.pred <- as.numeric(polls.pred)
fund.pred <- as.numeric(fund.pred)
